...
2. **`plan.html` — planning.** Pick the day, the start time, where you meet, the food, and the
   activities (with room for your own ideas). Everything you pick is turned into a real timed
   schedule, live, as you choose it. Reorder the day with *eat first / play first / mix it up*.
